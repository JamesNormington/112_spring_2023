...
You can download a template .Rmd of this activity [here](template_rmd/07-Reshaping_Data.Rmd).
...
Here is a nice summary graphic of `pivot_longer` and `pivot_wider` from the [RStudio cheat sheet on tidy data](https://raw.githubusercontent.com/rstudio/cheatsheets/main/tidyr.pdf):

```{r, out.width = "700px",echo=FALSE}
knitr::include_graphics("images/reshaping.jpeg")
```
