...
```{r, cache=TRUE}
partners <- read_csv("https://jamesnormington.github.io/112_fall_2022/data/kiva_partners2.csv")
```
...
loans <- read_csv("https://jamesnormington.github.io/112_fall_2022/data/kiva_loans_small.csv")
```
