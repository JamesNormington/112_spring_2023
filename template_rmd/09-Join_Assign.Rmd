...
```{r}
Grades <- read_csv("https://jamesnormington.github.io/112_fall_2022/data/grades.csv")
Grades <- Grades %>%
...
```{r, cache=TRUE}
Courses <- read_csv("https://jamesnormington.github.io/112_fall_2022/data/courses.csv")
```
...
```{r cache=TRUE}
data_site <-
  "https://jamesnormington.github.io/112_fall_2022/data/2014-Q4-Trips-History-Data-Small.rds"
Trips <- readRDS(gzcon(url(data_site)))
Stations <- read_csv("https://jamesnormington.github.io/112_fall_2022/data/DC-Stations.csv")
```
