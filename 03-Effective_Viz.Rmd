...
```{exercise}
Pick one of the Science Notebook entries  at https://www.edwardtufte.com/tufte (far right at website). Write a brief reflection on the graphical principles that are illustrated by this entry.
```
