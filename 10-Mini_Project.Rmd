...
You can download a template .Rmd of this activity [here](template_rmd/10-Mini_Project.Rmd).
...
The `loans` [table](data/kiva_loans_small.csv) below contains information about individual loans to borrowers; full data is available [here](data/kiva_loans.csv).
