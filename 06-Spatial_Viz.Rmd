...
favorite_msp <- tibble(
  place = c(
    ...
    "Midtown Global Market", "Hard Times Cafe"
  ),
  long = c(
    -93.1712321, 
    -93.2534,
...
```{r fig.alt='Interactive map of my favorite places in the Twin Cities.'}
...
```{r fig.alt='Interactive map of my favorite places in the Twin Cities, connected with a line.'}
leaflet(data = favorite_msp) %>%
...
## Assignment 4: due Wednesday, Feb. 15th at 11:59pm {-}

```{exercise}
   
In this assignment, you are going to create a single map of some of your favorite places! The end result will be one map.    
