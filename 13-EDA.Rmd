...
- [Married people have more sex](http://flowingdata.com/2017/07/03/married-people-sex/)

- [Tropical storm analysis](https://www.r-bloggers.com/2017/09/exploratory-data-analysis-of-tropical-storms-in-r/)

## Assignment 8 Part 2 (due Wednesday, March 29th @ 11:59pm)  {-}
...
airlines <- read_csv("https://jamesnormington.github.io/112_spring_2023/data/airlines.csv")
airports <- read_csv("https://jamesnormington.github.io/112_spring_2023/data/airports.csv")
flights <- read_csv("https://jamesnormington.github.io/112_spring_2023/data/flights_jan_jul_sample2.csv")
```
...
A codebook is available [here](https://www.transtats.bts.gov/databases.asp?Z1qr_VQ=E&Z1qr_Qr5p=N8vn6v10&f7owrp6_VQF=D), then go to "Airline On-Time Performance Data".

```{exercise, name="Explore codebook"}
  What are the levels of `CANCELLATION_REASON` and what do they mean? What is the unit of observation for each table?
