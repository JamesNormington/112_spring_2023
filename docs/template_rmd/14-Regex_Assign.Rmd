...
```{r}
load('https://bcheggeseth.github.io/112_fall_2022/data/Mac2021Courses.RData')
```
...
Make a histogram showing the number of Fall 2021 sections satisfying the Writing WA requirement (a `gen_ed`), sorted by department code.^[For this exercise, you can count cross-listed courses towards both departments' WA counts.]
...
Create and display a new table with all night courses (i.e., a subset of the table you wrangled by the end of the exercise 4). Also make a histogram showing the number of these courses by day of the week.
