...
```{r}
DailyGroups <- read_csv("https://jamesnormington.github.io/112_fall_2022/data/daily-group-assignment.csv")
Daily <- Daily %>%
...
Lesotho <- read_csv("https://jamesnormington.github.io/112_fall_2022/data/Lesotho.csv")
head(Lesotho)
```
